package com.example.software02.cryptocurrency;
...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,ListSourceAdapter.onListClickedRowListner {

    ListService listService = null;
    RecyclerView mainListOfCrypto = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainListOfCrypto = (RecyclerView) findViewById(R.id.main_crypto_list);
        listService= Helper.getNewsService();
        listService.getSources().enqueue(new Callback<List<RootObject>>() {
            ...
            public void onResponse(Call<List<RootObject>> call, Response<List<RootObject>> response) {
                ...
                mainListOfCrypto.setLayoutManager(linearLayoutManager);
                mainListOfCrypto.setAdapter(listSourceAdapter);
                mainListOfCrypto.setHasFixedSize(true);
               // mainListOfCrypto.setAnimation(new DefaultItemAnimator());
